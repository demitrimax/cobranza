            ...
            <div id="myCarouse2" class="carousel vcarousel slide p-20">
              ...
              <div class="carousel-inner ">
                <div class="active item">
                  ...
                  <div class="twi-user"><img src=
                    "{{ asset('themes/plugins/images/users/hritik.jpg') }}"
                ...
                <div class="item">
                  <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                  <div class="twi-user"><img src=
                    "{{ asset('themes/plugins/images/users/genu.jpg') }}"
                    alt="user" class="img-circle img-responsive pull-left">
                    <h4 class="text-white m-b-0">Govinda</h4>
                    <p class="text-white">Actor</p>
                  </div>
                ...
                <div class="item">
                  <h3 class="text-white">My Acting blown <span class="font-bold">Your Mind</span> and you also laugh at the moment</h3>
                  <div class="twi-user"><img src=
                    "{{ asset('themes/plugins/images/users/ritesh.jpg') }}"
                    alt="user" class="img-circle img-responsive pull-left">
                    <h4 class="text-white m-b-0">Govinda</h4>
                    <p class="text-white">Actor</p>
                  </div>
        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
          <div class="white-box">
            ...
            <div class="comment-center">
              ...
              <div class="comment-body">
                <div class="user-img"> <img src=
                    "{{ asset('themes/plugins/images/users/sonu.jpg') }}"
                    alt="user" class="img-circle"> </div>
                <div class="mail-contnet">
                  <h5>Sonu Nigam</h5>
              ...
              <div class="comment-body">
                <div class="user-img"> <img src=
                    "{{ asset('themes/plugins/images/users/arijit.jpg') }}"
                    alt="user" class="img-circle"> </div>
                <div class="mail-contnet">
                  <h5>Arijit Sinh</h5>
        ...
        <div class="col-md-4 col-xs-12 col-sm-6">
          <div class="white-box">
            ...
            <div class="message-center"> <a href="#">
              <div class="user-img"> <img src=
                "{{ asset('themes/plugins/images/users/pawandeep.jpg') }}"
                alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
              <div class="mail-contnet">
                <h5>Pavan kumar</h5>
              ...
              <div class="user-img"> <img src=
                "{{ asset('themes/plugins/images/users/sonu.jpg') }}"
                alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
              <div class="mail-contnet">
                <h5>Sonu Nigam</h5>
              ...
              <div class="user-img"> <img src=
                "{{ asset('themes/plugins/images/users/arijit.jpg') }}"
                alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
              <div class="mail-contnet">
                <h5>Arijit Sinh</h5>
          ...
          <div class="white-box">
            ...
            <div class="chat-box">
              <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                <li>
                  <div class="chat-image"> <img alt="male" src=
                    "{{ asset('themes/plugins/images/users/sonu.jpg') }}"
                    > </div>
                  <div class="chat-body">
                    <div class="chat-text">
                ...
                <li class="odd">
                  <div class="chat-image"> <img alt="Female" src=
                    "{{ asset('themes/plugins/images/users/genu.jpg') }}"
                    > </div>
                  <div class="chat-body">
                    <div class="chat-text">
          ...
          <div class="r-panel-body">
            ...
            <ul class="m-t-20 chatonline">
              ...
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/varun.jpg') }}"
                alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/genu.jpg') }}"
                alt="user-img"  class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/ritesh.jpg') }}"
                alt="user-img"  class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/arijit.jpg') }}"
                alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/govinda.jpg') }}"
                alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/hritik.jpg') }}"
                alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/john.jpg') }}"
                alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a></li>
              <li><a href="javascript:void(0)"><img src=
                "{{ asset('themes/plugins/images/users/pawandeep.jpg') }}"
                alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a></li>
            </ul>
          </div>
        </div>
      </div>
