                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table display" id="table-content">
                      ...
                      <?php foreach($data as $value) { ?>
                        <tr>
                          <td>
                            <?php if($value->renovacion == 1) { ?>
                              <span title="Renovacion de Credito"> <li class="fa fa-recycle fa-lg text-success"></li></span>
                            <?php } ?>

                            <?php if($value->status == 1) { ?>
                              <span title="HABILITADA, ACTIVA"> <li class="fa fa-check-circle fa-lg text-success"></li></span>
                            <?php } else { ?>
                              <span title="DESHABILITADA, INACTIVA"> <li class="fa fa-warning fa-lg text-warning"></li></span>
                            <?php }  ?>
                          ...
                          <td>$ {{{ number_format($value->monto_solicitado,2,".",",") }}}</td>
            						  <td>{{{ $value->plazo_solicitado }}}</td>
                          <td>
                           <a href="<?php echo url("/"); ?>/admin/solicitudes/view/<?php echo $value->id; ?>" title="Ver Solicitud" data-toggle="tooltip">
                           ...
                           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/solicitudes/baja/<?php echo $value->id; ?>" data-title="Eliminar solicitudes" style="border:0px; background:none">
