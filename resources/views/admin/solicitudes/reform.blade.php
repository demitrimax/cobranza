...
<input type="hidden" id="solicitud_renueva_id" name="solicitud_renueva_id" value="{!! $credito->solicitud_id !!}" class="form-control"/>
...
<!-- .row -->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Solicitud de Refinanciamiento</h3>
                            ...
                            <div id="exampleBasic2" class="wizard">
                                <ul class="wizard-steps" role="tablist">
                                    <li class="active" role="tab">
                                        <h4><span><i class="ti-user"></i></span>Datos del Cliente</h4>
                                    </li>
                                    <li role="tab">
                                        <h4><span><i class="ti-credit-card"></i></span>Datos del Crédito</h4>
                                    </li>
                                    <li role="tab">
                                      	...
                                      	<div class="panel panel-default">
                                      		...
                                      		<div class="panel-wrapper collapse in" aria-expanded="true">
                                                ...
                                                <!-- CURP Start -->
                                      					...
                                      					<div class="form-group curpfield">
                                      					     <label for="curp" class="control-label"> CURP </label> <span class="text-danger">*</span>
                                      					      ...
                                      					      value="{{{ isset($cliente->curp ) ? $cliente->curp  : old('curp') }}}" maxlength="18" onchange="validarInput(this)" readonly>
                                                ...
                                                <div class="label label-danger">{{ $errors->first("curp") }}</div>
                                      					...
                                      					value="{{{ isset($cliente->nombre ) ? $cliente->nombre  : old('nombre') }}}" maxlength="150" readonly>
                                      					...
                                      					value="{{{ isset($cliente->paterno ) ? $cliente->paterno  : old('paterno') }}}" maxlength="150" readonly>
                                                ...
                                                onchange="validarNombrecompleto()" readonly>
