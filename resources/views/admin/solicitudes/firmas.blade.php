                      ...
                      <?php foreach($data as $value) { ?>
                        <tr id="hide<?php $value->id; ?>" >
                          ...
                          <td>{{{ $value->plazo_solicitado }}}</td>
		                      <td>
                             <a href="<?php echo url("/"); ?>/admin/solicitudes/firmar/<?php echo $value->id?>" title="Firmar de Contratos" data-toggle="tooltip">
                              <i class="fa fa-calendar fa-lg text-default m-r-10"></i>
                             </a>

                             <button type="button" data-toggle="tooltip" title="Enviar a Dispersión" class="avanza" style="border:0px" data-url="<?php echo url("/"); ?>/admin/solicitudes/avanzar/<?php echo $value->id?>" >
                               <i class="fa fa-money fa-lg text-success m-r-10"></i>
                             </button>
