      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/documentos_reglas/add') }}" class="btn btn-info ">
        ...
        <div class="col-sm-12" id="frmListado">
          ...
          <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <table class="table display" id="table-content">
                      <thead>
                        <tr>
                          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><td>Documento_id</td>
						<td>Regla</td>
						<td>Status</td>
            ...
            {{{ $value->status }}}
                 ...
                 <td>
           <a href="<?php echo url("/"); ?>/admin/documentos_reglas/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
           </a>
           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/documentos_reglas/edit/<?php echo $value->id; ?>" data-title="Eliminar documentos_reglas" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="documentos_reglas.documento_id" <?php echo $searchBy=="documentos_reglas.documento_id"?'selected="selected"':""; ?>>Documento_id</option><option value="documentos_reglas.regla" <?php echo $searchBy=="documentos_reglas.regla"?'selected="selected"':""; ?>>Regla</option><option value="documentos_reglas.status" <?php echo $searchBy=="documentos_reglas.status"?'selected="selected"':""; ?>>Status</option>
                        </select>
                     </div>
                  </div>
