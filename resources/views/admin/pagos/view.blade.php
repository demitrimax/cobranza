                ...
                <div class="panel-body">
                  {{ csrf_field() }}
                    <table class='table table-bordered' style='width:70%;' align='center'>
											...
											<tr>
											 <td>
											  <label class="control-label col-md-3"> Credito_id </label>
											 </td>
											 <td>
										     {{{ $data->cliente_id }}}
											 </td>
										    ...
										    <!-- Credito_id End -->
															...
															<tr>
															 <td>
															   <label for="hora_pago" class="col-sm-3 control-label"> Hora_pago </label>
															 </td>
															 <td>
															   {{{ $data->hora_pago }}}
															 </td>
															...
															<tr>
															 <td>
															   <label for="monto_pago" class="col-sm-3 control-label"> Monto_pago </label>
															 </td>
															 <td>
															   {{{ $data->monto_pago }}}
															 </td>
