      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/pagos/add') }}" class="btn btn-info ">
        ...
        <div class="col-sm-12" id="frmListado">
          ...
          <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <table class="table display" id="table-content">
                      <thead>
                        <tr>
                          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><td>Credito_id</td><td>Fecha_pago</td>
						<td>Hora_pago</td>
						<td>Monto_pago</td>
						<td>Status</td>
            ...
            {{{ $value->status }}}
                 ...
                 <td>
           <a href="<?php echo url("/"); ?>/admin/pagos/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
           </a>
           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/pagos/edit/<?php echo $value->id; ?>" data-title="Eliminar pagos" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="creditos.cliente_id" <?php echo $searchBy=="creditos.cliente_id"?'selected="selected"':""; ?>>Credito_id</option><option value="pagos.fecha_pago" <?php echo $searchBy=="pagos.fecha_pago"?'selected="selected"':""; ?>>Fecha_pago</option><option value="pagos.hora_pago" <?php echo $searchBy=="pagos.hora_pago"?'selected="selected"':""; ?>>Hora_pago</option><option value="pagos.monto_pago" <?php echo $searchBy=="pagos.monto_pago"?'selected="selected"':""; ?>>Monto_pago</option><option value="pagos.status" <?php echo $searchBy=="pagos.status"?'selected="selected"':""; ?>>Status</option>
                        </select>
                     </div>
                  </div>
