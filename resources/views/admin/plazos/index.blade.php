      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/plazos/add') }}" class="btn btn-info ">
        ...
        <div class="col-sm-12" id="frmListado">
          ...
          <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <table class="table display" id="table-content">
                      <thead>
                        <tr>
                          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><td>Plazo</td>
						<td>Periodicidad</td>
						<td>Status</td>
            ...
            {{{ $value->status }}}
                 ...
                 <td>
           <a href="<?php echo url("/"); ?>/admin/plazos/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
           </a>
           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/plazos/edit/<?php echo $value->id; ?>" data-title="Eliminar plazos" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="plazos.plazo" <?php echo $searchBy=="plazos.plazo"?'selected="selected"':""; ?>>Plazo</option><option value="plazos.periodicidad" <?php echo $searchBy=="plazos.periodicidad"?'selected="selected"':""; ?>>Periodicidad</option><option value="plazos.status" <?php echo $searchBy=="plazos.status"?'selected="selected"':""; ?>>Status</option>
                        </select>
                     </div>
                  </div>
