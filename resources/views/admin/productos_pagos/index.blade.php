      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/productos_pagos/add') }}" class="btn btn-info ">
        ...
        <div class="col-sm-12" id="frmListado">
          ...
          <div class="panel panel-default">
            ...
            {{{ $value->status }}}
                 ...
                 <td>
           <a href="<?php echo url("/"); ?>/admin/productos_pagos/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
           </a>
           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/productos_pagos/edit/<?php echo $value->id; ?>" data-title="Eliminar productos_pagos" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="productos_pagos.id" <?php echo $searchBy=="productos_pagos.id"?'selected="selected"':""; ?>>Id</option><option value="productos_pagos.producto_id" <?php echo $searchBy=="productos_pagos.producto_id"?'selected="selected"':""; ?>>Producto_id</option><option value="productos_pagos.monto" <?php echo $searchBy=="productos_pagos.monto"?'selected="selected"':""; ?>>Monto</option><option value="productos_pagos.status" <?php echo $searchBy=="productos_pagos.status"?'selected="selected"':""; ?>>Status</option>
                        </select>
                     </div>
                  </div>
