      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/documentos/add') }}" class="btn btn-info ">
                    ...
                    <table class="table display" id="table-content">
                      ...
                      <?php foreach($data as $value) { ?>
                        <tr id="hide<?php $value->id; ?>" >
                          ...
                          <td> <?php if($value->producto) { echo $value->producto; } else { echo '[ TODOS ]'; } ?> </td>
                          <td> {{{ $value->nombre }}} </td>
                          <td> <?php if($value->requerido == 1) { echo '<span class="text-danger"> REQUERIDO </span>'; } else { echo '<span class="text-warning"> OPCIONAL </span>'; } ?> </td>
                          <td>
                             <a href="<?php echo url("/"); ?>/admin/documentos/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
                              <i class="fa fa-edit fa-lg text-info m-r-10"></i>
                             </a>
                             <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/documentos/baja/<?php echo $value->id; ?>" data-title="Eliminar documentos" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="productos.descripcion" <?php echo $searchBy=="productos.descripcion"?'selected="selected"':""; ?>>Producto</option>
                         <option value="documentos.nombre" <?php echo $searchBy=="documentos.nombre"?'selected="selected"':""; ?>>Descripcion</option>
                        </select>
                     </div>
                  </div>
