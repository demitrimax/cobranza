                ...
                <div class="panel-body">
                  {{ csrf_field() }}
                    <table class='table table-bordered' style='width:70%;' align='center'>
															...
															<tr>
															 <td>
															   <label for="referencia1_parentesco" class="col-sm-3 control-label"> Referencia1_parentesco </label>
															 </td>
															 <td>
															   {{{ $data->referencia1_parentesco }}}
															 </td>
															</tr>
															<tr>
															 <td>
															...
															<tr>
															 <td>
															   <label for="referencia2_parentesco" class="col-sm-3 control-label"> Referencia2_parentesco </label>
															 </td>
															 <td>
															   {{{ $data->referencia2_parentesco }}}
															 </td>
															</tr>
															<tr>
															 <td>
															...
															<tr>
															 <td>
															   <label for="referencia3_parentesco" class="col-sm-3 control-label"> Referencia3_parentesco </label>
															 </td>
															 <td>
															   {{{ $data->referencia3_parentesco }}}
															 </td>
															</tr>
															<tr>
															 <td>
