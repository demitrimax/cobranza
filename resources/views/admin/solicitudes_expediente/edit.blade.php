...
<div id="page-wrapper">
  <div class="container-fluid">
      ...
      <div class="row">
        <form action="<?php echo url('/'); ?>/admin/solicitudes_expediente/edit" id="formValidation" method="post" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                  ...
                  @include('admin.solicitudes_expediente.form')
