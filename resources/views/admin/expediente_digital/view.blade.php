                ...
                <div class="panel-body">
                  {{ csrf_field() }}
                    <table class='table table-bordered' style='width:70%;' align='center'>
															...
															<tr>
															 <td>
															   <label for="user_id" class="col-sm-3 control-label"> Usuario </label>
															 </td>
															 <td>
															   {{{ $data->user_id }}}
															 </td>
															...
															<tr>
															 <td>
															   <label for="solicitud_id" class="col-sm-3 control-label"> Solicitud </label>
															 </td>
															 <td>
															   {{{ $data->solicitud_id }}}
															 </td>
															...
															<tr>
															 <td>
															   <label for="documento_id" class="col-sm-3 control-label"> Documento </label>
															 </td>
															 <td>
															   {{{ $data->documento_id }}}
															 </td>
