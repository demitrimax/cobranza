      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="white-box">
            ...
            <div class="pull-left">
              <a href="{{ url('/admin/dispersion/add') }}" class="btn btn-info ">
        ...
        <div class="col-sm-12" id="frmListado">
          ...
          <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="table-responsive">
                    ...
                    <table class="table display" id="table-content">
                      <thead>
                        <tr>
                          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?><td>Id</td>
						<td>Solicitud_id</td>
						<td>User_id</td>
						<td>Fecha</td>
						<td>Cuenta_origen</td>
						<td>Cuenta_destino</td>
						<td>Monto</td>
						<td>Observaciones</td>
						<td>Status</td>
            ...
            {{{ $value->status }}}
                 ...
                 <td>
           <a href="<?php echo url("/"); ?>/admin/dispersion/edit/<?php echo $value->id; ?>" title="Edit" data-toggle="tooltip">
            <i class="fa fa-edit fa-lg text-info m-r-10"></i>
           </a>
           <button type="button" data-toggle="tooltip" class="delete" data-url="<?php echo url("/"); ?>/admin/dispersion/edit/<?php echo $value->id; ?>" data-title="Eliminar dispersion" style="border:0px; background:none">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="searchBy" class="form-control selectpicker">
                         <option value="dispersion.id" <?php echo $searchBy=="dispersion.id"?'selected="selected"':""; ?>>Id</option><option value="dispersion.solicitud_id" <?php echo $searchBy=="dispersion.solicitud_id"?'selected="selected"':""; ?>>Solicitud_id</option><option value="dispersion.user_id" <?php echo $searchBy=="dispersion.user_id"?'selected="selected"':""; ?>>User_id</option><option value="dispersion.fecha" <?php echo $searchBy=="dispersion.fecha"?'selected="selected"':""; ?>>Fecha</option><option value="dispersion.cuenta_origen" <?php echo $searchBy=="dispersion.cuenta_origen"?'selected="selected"':""; ?>>Cuenta_origen</option><option value="dispersion.cuenta_destino" <?php echo $searchBy=="dispersion.cuenta_destino"?'selected="selected"':""; ?>>Cuenta_destino</option><option value="dispersion.monto" <?php echo $searchBy=="dispersion.monto"?'selected="selected"':""; ?>>Monto</option><option value="dispersion.observaciones" <?php echo $searchBy=="dispersion.observaciones"?'selected="selected"':""; ?>>Observaciones</option><option value="dispersion.status" <?php echo $searchBy=="dispersion.status"?'selected="selected"':""; ?>>Status</option>
                        </select>
                     </div>
                  </div>
